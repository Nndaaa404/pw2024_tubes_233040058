...
function ubah($data) {
    ...
    $query_existing = "SELECT * FROM posts WHERE id_post = '$id_post'";
    ...
    if ($title === $existing_data['title'] &&
        $id_category === $existing_data['id_category'] &&
    ...
    $query_update = "UPDATE posts SET id_category = '$id_category', title = '$title', excerpt = '$excerpt', body = '$body', image = '$image' 
