...
<body>
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Resep Kita</a>
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                ...
                                <?php endif; ?>
                                <a class="nav-link d-flex align-items-center gap-2" aria-current="page" href="profile.php">
                                    <svg class="bi">
                                        <use xlink:href="#house-fill" />
                                    </svg>
                                    Profile
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-VoPF23dETy7QK86XxE13KblLqW4dMO1rZ7eTQozJ5gr5JbKTX6r7Y4Fr86L8Ns2x" crossorigin="anonymous"></script>
</body>
