...
<body>
  ...
  <div class="container my-5">
    <div class="p-5 text-center bg-body-tertiary rounded-3">
      ...
      <h1 class="text-body-emphasis">Selamat datang di website Resep Kita</h1>
      <p class="col-lg-8 mx-auto fs-5 text-muted">
      Jelajahi beragam resep kuliner dari berbagai belahan dunia, mulai dari makanan tradisional hingga hidangan modern yang menggugah selera!
      </p>
